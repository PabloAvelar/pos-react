...
<center><strong>De : <input type="text" style="width: 223px; padding:14px;" name="d1" class="tcal" value="" /> Para: <input type="text" style="width: 223px; padding:14px;" name="d2" class="tcal" value="" />
...
Informe de ventas&nbsp;<?php echo $_GET['d1'] ?>&nbsp;to&nbsp;<?php echo $_GET['d2'] ?>
</div>

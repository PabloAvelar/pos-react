...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
              ...
              <li><a href="index.php"><i class="icon-dashboard icon-2x"></i> Panel </a></li> 
			...
			<li class="active"><a href="sales_inventory.php"><i class="icon-table icon-2x"></i> Inventario</a>                </li>
			<br><br><br><br><br><br>		
			<li>
	...
	<div class="contentheader">
			<i class="icon-bar-chart"></i> Inventario
			</div>
<br>
...
<button  style="float:left;" class="btn btn-success btn-mini"><a href="javascript:Clickheretoprint()"> Imprimir</button></a>
</div>
<br>
<br>
<br>
...
<br><br><br>
<center><strong>Inventario</strong></center>
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
		<th width="12%"> Factura </th>
<th width="9%"> Fecha </th>
<th width="14%"> Nombre de la Marca </th>
<th width="16%"> Nombre Genérico </th>
<th width="15%"> Categoría / Descripción </th>
<th> Precio </th>
<th> Cant. </th>

<th width="8%"> Monto Total </th>
<th width="8%"> Ganancia </th>
...
<th> Acción </th>
	...
	<tbody>
			...
			?></td>
			<td> 				
			<a href="deletesalesinventory.php?id=<?php echo $row['transaction_id']; ?>&qty=<?php echo $row['qty'];?>"><button class="btn btn-mini btn-danger"><i class="icon icon-trash"></i> Borrar </button></a>
			</tr>
			<?php
				}
			?>
